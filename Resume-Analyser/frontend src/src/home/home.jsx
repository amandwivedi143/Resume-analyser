           ...
           {isshow && islogged? <div id="menu" className={Styles.profilemenu}>
            ...
            <div className={Styles.core}>
                ...
                <div className={Styles.btncontainer} >
                    ...
                    {islogged?<button disabled={isloading} onClick={()=>navigate("/codingtest")}>Take Coding Test</button>:null}
                    {islogged?<button disabled={isloading} onClick={()=>navigate("/careerroadmap")}>Career Roadmap</button>:null}
